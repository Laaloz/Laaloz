...
- Agentic development: OpenCode (Copilot/GPT), Claude, MCP servers in the workflow
- Figma design-to-code with agents
- TypeScript across the stack (Next.js, Supabase, Swift clients)
- Keyboards, firmware and small hardware

## Stack

<p>
  <img src="https://skillicons.dev/icons?i=ts,js,react,nextjs,astro,vue,nodejs,php,postgres,supabase,swift,html,css,sass,tailwind,docker,git,bitbucket,figma" />
</p>

## About this GitHub

Most of my professional work is in private client repositories. The public repos above are my own projects; older course and exercise repos are archived.
